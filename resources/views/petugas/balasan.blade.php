        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="{{ route('post.tanggapan', $p->id) }}" method="POST">
              @csrf
              ...
              <div class="card-footer">
                <div class="float-right">
                  ...
                  <button onclick="return hapus('Anda yakin akan mengirimkan tanggapan?')" type="submit" class="btn btn-primary"><i class="far fa-envelope"></i> Send</button>
                </div>
              </div>
              </form>
              <!-- /.card-footer -->
