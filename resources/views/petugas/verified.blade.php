...
@section('title', 'Pengaduan Terverifikasi')
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-date"><a href="{{ url('petugas/balasan/'.$p->id) }}" class="btn btn-app"><i class="fas fa-pencil-alt"></i>Kirim Tanggapan</a></td>
                  </tr>
                  @endforeach
                  </tbody>
                </table>
